                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="json_params[brief][vi]" class="form-control" id="brief_vi" rows="2">{{ isset($detail->json_params->brief->vi) ? $detail->json_params->brief->vi : old('json_params[brief][vi]') }}</textarea>
                    </div>
                  </div>
